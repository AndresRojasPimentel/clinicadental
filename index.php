...
<body>
  ...
  <header id="header">
    <div class="container">
      <div id="logo" class="pull-left">
        <a href="#hero"><img src="img/logoDW3.png" alt="" title="" /></img></a>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="views/vistaLogin.php">Reservar Cita</a></li>
        </ul>
      </nav>
      <!-- #nav-menu-container -->
    </div>
    ...
    <div class="container about-container wow fadeInUp">
      <div class="row">
        <div class="col-md-6 col-md-push-6 about-content">
          ...
          <p class="about-text" >
            Ser un centro dental líder, con la más avanzada tecnología y un equipo de odontólogos, técnicos y administrativos comprometidos con la evidencia científica y la mejora continua.
          </p>

          <h2 class="about-title">MISIÓN</h2>
          <p class="about-text">
            Brindar atención odontológica especializada y personalizada, dando soluciones con calidad y calidez a nuestros pacientes.
          </p>
          <h2 class="about-title">VALORES</h2>
          <p class="about-text">
            La máxima calidad como meta. Pasión, constancia y puntualidad. Confianza, empatía y calidez. Trabajo en equipo.
          </p>
        </div>
      </div>
    </div>
  ...
  <section id="services">
    <div class="container wow fadeInUp">
      ...
      <div class="row">
        ...
        <div class="col-md-4 service-item">
          <div class="service-icon"><i class="fa fa-heart"></i></i></div>
  ...
  <section id="subscribe">
    <div class="container wow fadeInUp">
      <div class="row">
        <div class="col-md-8">
          <h3 class="subscribe-title">Siguenos en facebook</h3>
          <p class="subscribe-text">Para mantenerte informado en la especialidad de odontologia, nuestros proyectos y descuentos, que esperas!.</p>
        </div>
        <div class="col-md-4 subscribe-btn-container">
          <a class="subscribe-btn" href="https://www.facebook.com/whitedentalperu/?ref=page_internal">Ir a facebook</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="testimonials">
    <div class="container wow fadeInUp">
      <div class="row">
        <div class="col-md-12">
          <h3 class="section-title">Testimonios de nuestros pacientes</h3>
          <div class="section-title-divider"></div>
          <p class="section-description">En esta sección usted encontrará casos reales de pacientes atendidos en DentalWhite</p>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="profile">
            <div class="pic"><img src="img/cliente1.jpg" alt=""></div>
            <h4>Eduardo Gonzales</h4>
            <span>Ig. de Sistemas</span>
          </div>
        </div>
        <div class="col-md-9">
          <div class="quote">
            <b><img src="img/quote_sign_left.png" alt=""></b>La clínica es muy buena, muy limpia y los tratamientos siempre muy bien. Cuando hay algún problema, llamamos y dan una solución muy rápida. Estamos muy contentos con todo el equipo y naturalmente con Bruno. Estamos muy agradecidos por todo.<small><img src="img/quote_sign_right.png" alt=""></small>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-9">
          <div class="quote">
            <b><img src="img/quote_sign_left.png" alt=""></b>Estoy encantada con esta clínica y su personal, del primero al último. Personas muy profesionales y encantadoras. Hemos pasado por aquí mis hijos, mis padres y yo, y ha sido y es una experiencia 10. Resultados estupendos en los tratamientos y el personal atento a cualquier duda, contratiempo o lo que pueda surgir. En resumen: me encanta!<small><img src="img/quote_sign_right.png" alt=""></small>
          </div>
        </div>
        <div class="col-md-3">
          <div class="profile">
    ...
    <div class="container wow fadeInUp">
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="section-title-divider"></div>
          <p class="section-description">Contamos con un equipo de primera calidad formado por los mejores especialistas en diversas disciplinas dentales. Esto nos permite un control único del tratamiento de principio a fin, y un solo punto de contacto con el paciente.</p>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-3">
          <div class="member">
            <div class="pic"><img src="img/team-2.jfif" alt=""></div>
            <h4>Ivan Suarez</h4>
        ...
        <div class="col-md-3">
          <div class="member">
            <div class="pic"><img src="img/team-3.jfif" alt=""></div>
        ...
        <div class="col-md-3">
          <div class="member">
            <div class="pic"><img src="img/team-41.jpg" alt=""></div>
            <h4>Amanda Jepson</h4>
            <span>Pediatra</span>
            <!-- <div class="social">
              <a href=""><i class="fa fa-twitter"></i></a>
