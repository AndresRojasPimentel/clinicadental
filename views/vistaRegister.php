...
if(isset($_POST['btnRegistrar'])){
  ...
  $newUser= new Usuario;
  $registrar= $newUser->setUsuarios($_POST['name'],$_POST['telf'],$_POST['user'],$_POST['pass'],$_POST['correo']);
}
  ...
  <section id="hero">
    <div class="hero-container">
      <div class="wow fadeIn">
        ...
        <div class="actions">
          <a href="vistaLogin.php#about" class="btn-get-started">Ingresar</a>
          <a href="#about" class="btn-services">Registrar</a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container about-container wow fadeInUp">
      <div class="row">
        <div class="col-md-6 col-md-push-6 about-content">
          ...
          <p class="about-text">
                  <div class="form-outline mb-2">
                    <label class="form-label" for="form1Example2">Si ya cuentas con un usuario, Ingresa aquí                 <a href="vistaLogin.php#about">Ingresar</a> </label> 
                  </div>
                  <br>
