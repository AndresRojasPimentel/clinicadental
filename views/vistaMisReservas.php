  ...
  <header id="header">
    <div class="container">
      <div id="logo" class="pull-left">
        <a href="../views/vistaUsuario.php"><img src="../img/logoDW3.png" alt="" title="" /></img></a>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="../views/vistaUsuario.php">Reservar Cita</a></li>
    ...
    <div class="container wow fadeInUp">
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="section-title-divider"></div>
          <p class="section-description">En esta sección visualizara las reservas que ha realizado en DentalWhite</p>
        </div>
      </div>
