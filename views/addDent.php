<?php
    ...
    if(isset($_POST['btnAgregarD'])){
        ...
        $reg= new Dentista;
        $newUser=$reg->setDentistas($_POST['name'],$_POST['user'],$_POST['pass'],$_POST['espec']);
        if($newUser==true){
            echo "<script> alert('Dentista Registrado');</script>";
        }
    ...
    ?><div class="container-fluid px-4">
        <h1 class="mt-4">Agregar Dentistas</h1>    
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"> <a href="../views/vistaAdmin.php">Inicio</a></li>
            <li class="breadcrumb-item active"> Agregar Dentistas</li>
        </ol>
        <div class="card mb-4">
            <div class="card-body">
                En esta sección podra agregar Dentistas a la base de datos de DentalWhite.
            </div>
        </div>
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <p class="about-text">
                            ...
                            <br>
                        <button type="submit" class="btn btn-primary btn-block" name="btnAgregarD">Agregar Dentista <i class="fa fa-briefcase-medical me-2"></i> </button>
                    </p>
                    </form>
