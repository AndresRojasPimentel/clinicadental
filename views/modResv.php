<?php
    ...
    if(isset($_POST['btnAgregar'])){
        ...
        $reg= new Reserva;
        $newReg=$reg->editReservas($_POST['id_reserva'],$_POST['id'],$_POST['id_dentista'],$_POST['hora'],$_POST['fecha'],$_POST['name'],$_POST['telf'],$_POST['asunt'],$_POST['est']);
        if($newReg==true)
    ...
    ?><div class="container-fluid px-4">
        <h1 class="mt-4">Editar Reservas</h1>    
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"> <a href="../views/vistaAdmin.php">Inicio</a></li>
            <li class="breadcrumb-item active"> Editar Reservas</li>
        </ol>
        <div class="card mb-4">
            <div class="card-body">
                En esta sección podra editar información de las Reservas en la base de datos de DentalWhite.
            </div>
        </div>
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <p class="about-text" >
                                ...
                                <input type="text" id="form2Example1" class="form-control" value="<?php error_reporting(0); echo "".$_POST['id_reserva']."";?>" name="id_reserva" placeholder="Necesario para modificar" maxlength="49" required/>
                    ...
                    <p class="about-text">
                            <div class="form-outline mb-2">
                                <label class="form-label" for="form1Example2">ESTADO DE LA RESERVA</label>
                                <input type="text" id="form1Example2" class="form-control" value="<?php error_reporting(0); echo "".$_POST['est']."";?>" placeholder="pendiente / concluido" name="est" required maxlength="9" />
                    ...
                    <p class="about-text">
                            ...
                            <br>
                        <button type="submit" class="btn btn-primary btn-block" name="btnAgregar">Modificar Reserva <i class="fa fa-edit me-2"></i> </button>
                    </p>
                    </form>
