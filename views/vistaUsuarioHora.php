    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="../views/vistaUsuarios.php#portfolio">Casos clínicos</a></li>
            ...
            <?php
                if(isset($_POST['btnValidar'])){
                    ...
                    $horas[6]['hora']==$time.":00hs"||$horas[7]['hora']==$time.":00hs"||$horas[8]['hora']==$time.":00hs")
                        ...
                        //ME QUEDE EN LA PARTE DE APRETAR EL BOTON Y SALEN SEGÚN LAS HORAS RESERVADAS EN LA BASE DE DATOS
                    echo "<br>";
                    echo "<br>
                    </form>";
